<template>
  <section class="flex flex-col items-center text-center">
    ...
    <article>
      ...
      <h1 class="text-rojo text-2xl">Tu guía en el proceso</h1>
      <div class="div-parrafo">
        <span class="text-sm parrafo">
          Te guiamos durante el proceso de compraventa y te brindamos las
          herramientas necesarias para una
        </span>
        <span class="text-sm"> transacción confiable. </span>
      </div>
    </article>
  </section>
</template>
