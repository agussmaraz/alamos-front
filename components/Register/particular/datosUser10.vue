<template>
    <section class="flex flex-col items-center text-center">
        <span class="flex text-2xl mt-6 header text-center text-rojo"> Términos y Condiciones </span>
        <div class="text-sm div-parrafo">
            <span class="parrafo">Para abrir tu cuenta de</span>
            <span>Álamos</span>
            <span class="parrafo">tienes que aceptar los términos y condiciones.</span>
        </div>
