    ...
    <section class="w-full">
      <article class="relative mt-20">
        <input
          ...
          @click="activate('nombre')"
          @focus="activate('nombre')"
        ...
        <div
          ...
          :class="
            active === 'nombre' || data.nombre != '' ? 'moveLabel' : false
          "
        >
          <label class="text-rojo text-xs" @click="activate('nombre')"
      ...
      <article class="relative my-12">
        ...
        <div
          class="div-label absolute px-2"
          :class="
            active === 'apellido' || data.apellido != '' ? 'moveLabel' : false
          "
        >
          <label for="" class="text-rojo text-xs" @click="activate('apellido')"
      ...
      <div class="relative">
        <article
          class="flex justify-around items-center border border-rojo rounded-md h-16 m-auto button-sex"
          :class="{ inputError: errores.genero && errores.genero.error }"
        >
          <button
            class="text-xs h-full w-full outline-none"
            :class="buttonGenero === 'masculino' ? 'activateButton' : false"
          ...
          <button
            ...
            :class="buttonGenero === 'femenino' ? 'activateButton' : false"
          ...
          <button
            class="text-xs h-full w-full outline-none"
            :class="buttonGenero === 'otro' ? 'activateButton' : false"
            @click="setGender('otro')"
          >
            Otros
          </button>
        </article>
