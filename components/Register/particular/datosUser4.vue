<template>
    <section class="flex flex-col items-center text-center">
        <IconEmailHeart class="w-20 mt-6" />
        <span class="flex text-2xl mt-6 header text-center"> ¡Te enviamos un correo! </span>
        <div class="parrafo text-sm div-parrafo">
            <p>Te acabamos de enviar un email para verificar tu dirección de correo.</p>
            <br />
