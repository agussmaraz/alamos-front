<template>
    <section>
        <nav class="nav flex justify-between items-center px-3 pt-2 pb-1 fixed w-full z-20">
            ...
            <div class="font-bold text-center w-40 ml-4">2019 SUBARU OUTBACK 3.6R ES</div>
        ...
        <section class="container-footer w-full h-20 flex items-center justify-around fixed bottom-0">
            <nuxt-link to="/ventas/automoviles/modificar" class="button-modificar font-bold w-48 h-12"> Modificar/Finalizar </nuxt-link>
            <nuxt-link to="/ventas/automoviles/impulsar" class="w-40 button-impulsar h-12 font-semibold flex items-center justify-center">
