<template>
    <section class="caja-madre">
        ...
        <article v-if="componente_actual !== 'MotoDetalles'" class="caja-pasos flex justify-between mt-5 px-8 py-4">
            ...
            <div class="div-icon">
                <IconCamera
                    ...
                    :class="{
                        indicado: componente_actual === 'MotoFotos' || componente_actual === 'MotoImperfecciones' || componente_actual === 'MotoUbicacion' || componente_actual === 'MotoComentarios',
                    }"
                />
            </div>
            <div class="div-icon">
                <IconCarPin
                    ...
                    :class="{
                        indicado: componente_actual === 'MotoUbicacion' || componente_actual === 'MotoComentarios',
                    }"
                />
            </div>
            <div class="div-icon">
        ...
        <article class="caja-componente mb-40">
            ...
            <div v-if="componente_actual !== 'MotoComentarios'" class="bg-rojo w-48 py-2 text-center rounded-3xl shadow-lg m-auto button-sig">
        ...
        <section v-if="ModalMotoImperfecciones" class="absolute inset-0 flex justify-center">
            <article class="modal z-10" @click="closeModal({ modal: 'motoImperfecciones' })"></article>
...
<script>
    ...
    export default {
        ...
        components: {
            ...
            MotoImperfecciones: () => import('@/components/Sales/moto/MotoImperfecciones'),
            MotoImperfecciones2: () => import('@/components/Sales/moto/MotoImperfecciones2'),
