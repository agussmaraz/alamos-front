<template>
    <section class="caja-madre">
        ...
        <article class="caja-componente mb-40">
            ...
            <div v-if="componente_actual !== 'MotoCaracteristicas'" class="bg-rojo w-48 py-2 text-center rounded-3xl shadow-lg m-auto button-sig">
...
<script>
    export default {
        ...
        components: {
            ...
            MotoForm: () => import('@/components/Sales/moto/MotoForm'),
            MotoForm1: () => import('@/components/Sales/moto/MotoForm1'),
            MotoCaracteristicas: () => import('@/components/Sales/moto/MotoCaracteristicas'),
        },
        data() {
            return {
                componente_actual: 'MotoForm',
            };
        },
        methods: {
            changePage() {
                ...
                if (this.componente_actual === 'MotoForm') {
                    ...
                    this.componente_actual = 'MotoCaracteristicas';
                }
            },
        },
    };
