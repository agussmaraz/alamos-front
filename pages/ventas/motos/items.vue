    ...
    <section>
        <article class="caja-nav pb-3 fixed z-20 w-full">
            ...
            <article class="flex items-center justify-around py-3">
                <p class="font-bold w-1/3 text-center pb-2" :class="componente_actual == 'MotoSeguridad' ? 'active' : false" @click="componente_actual = 'MotoSeguridad'">Seguridad</p>
                <p class="font-bold w-1/3 text-center pb-2" :class="componente_actual == 'MotoConfort' ? 'active' : false" @click="componente_actual = 'MotoConfort'">Confort</p>
                <p class="font-bold w-1/3 text-center pb-2" :class="componente_actual == 'MotoOtros' ? 'active' : false" @click="componente_actual = 'MotoOtros'">Otros</p>
            </article>
