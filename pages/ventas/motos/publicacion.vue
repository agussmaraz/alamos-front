<template>
    <section>
        ...
        <section class="container-footer w-full h-20 flex items-center justify-around fixed bottom-0">
            <nuxt-link to="/ventas/motos/modificar" class="button-modificar font-bold w-48 h-12"> Modificar/Finalizar </nuxt-link>
            <nuxt-link to="/ventas/motos/impulsar" class="w-40 button-impulsar h-12 font-semibold flex items-center justify-center">
