<template>
  <section class="caja-madre">
        ...
        <IconCamera
          ...
          :class="{
            indicado:
              ...
              componente_actual === 'OtroImperfecciones' ||
              componente_actual === 'OtroUbicacion' ||
              componente_actual === 'OtroComentarios',
          }"
        />
      </div>
      <div class="div-icon">
    ...
    <article class="caja-componente mb-40">
      ...
      <div
        v-if="componente_actual !== 'OtroComentarios'"
    ...
    <section
      v-if="ModalOtroImperfecciones"
      class="absolute inset-0 flex justify-center"
    >
      <article
        class="modal z-10"
        @click="closeModal({ modal: 'otroImperfecciones' })"
      ></article>
...
export default {
  ...
  components: {
    ...
    OtroImperfecciones: () =>
      import('@/components/Sales/otro/OtroImperfecciones'),
