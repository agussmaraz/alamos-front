    ...
    <article class="caja-nav pb-3 fixed z-20 w-full">
      ...
      <article class="flex items-center justify-around py-3">
        <p
          ...
          :class="componente_actual == 'OtroSeguridad' ? 'active' : false"
          @click="componente_actual = 'OtroSeguridad'"
        >
          Seguridad
        </p>
        <p
          class="font-bold w-1/3 text-center pb-2"
          :class="componente_actual == 'OtroConfort' ? 'active' : false"
          @click="componente_actual = 'OtroConfort'"
        >
          Confort
        </p>
        <p
          class="font-bold w-1/3 text-center pb-2"
          :class="componente_actual == 'OtroOtros' ? 'active' : false"
          @click="componente_actual = 'OtroOtros'"
        >
          Otros
        </p>
      </article>
